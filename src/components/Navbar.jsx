    ...
    <>
      <ul className={`${menuClicked ? 'hidden' : ''} absolute bg-white top-0 right-0 w-[256px] p-[24px] h-full text-[18px] sm:flex sm:items-center sm:w-[438px] sm:place-content-around sm:p-0 sm:h-auto sm:relative sm:text-[16px]`}>
        ...
        <li className='mb-8 sm:mb-0'>
          <Link  className='hover:text-SoftRed sm:text-4' to="/">Home</Link >
        </li>
        <li className='mb-8 sm:mb-0'>
          <Link className='hover:text-SoftRed' to="/new">New</Link>
        </li>
        <li className='mb-8 sm:mb-0'>
          <Link  className='hover:text-SoftRed' to="#">Popular</Link >
        </li>
        <li className='mb-8 sm:mb-0'>
          <Link  className='hover:text-SoftRed' to="#">Trending</Link >
        </li>
        <li className='mb-8 sm:mb-0'>
          <Link  className='hover:text-SoftRed' to="#">Categories</Link >
        </li>
      </ul>
